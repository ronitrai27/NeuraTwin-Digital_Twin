  ...
  return (
    <section className="w-full overflow-hidden relative min-[768px]:px-8 px-4 py-2 ">
      ...
      <main className=" z-10 my-10 relative flex flex-col items-center w-full h-full min-[1280px]:px-12 px-6">
        <h2 className="min-[800px]:mt-20 min-[1200px]:mt-36 mb-5 bg-gradient-to-b from-white via-gray-400 to-indigo-800/20 text-transparent bg-clip-text [-webkit-background-clip:text] min-[820px]:text-4xl text-3xl font-normal tracking-tight whitespace-nowrap  font-sora min-[1024px]:self-start text-center min-[1200px]:ml-20 ">
          Redifine your-self
        </h2>
      ...
      <div className="absolute h-[375px] w-[750px] sm:w-[1536px] sm:h-[768px] lg:w-[2000px] rounded-[100%] bg-black left-1/2 -translate-x-1/2  top-[calc(100%-140px)] sm:top-[calc(100%-146px)] border border-indigo-500 bg-[radial-gradient(closest-side,#000_82%,#7B68DA)]  "></div>
    </section>
  );
};
